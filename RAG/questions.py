def load_questions(language):
    if language == 'NL':
        return [
            ...
            "Hoe stichtte Napoleon zijn rijk in Europa?",
            ...
            "Wat was de impact van Napoleon op Engeland en Nederland?",
            "Was de impact van Napoleon op Engeland en Nederland destructief?"
        ]
        ...
        return [
            ...
            "What was the impact of Napoleon on England and the Netherlands?",
            "Was the impact of Napoleon on England and the Netherlands destructive?"
        ]
        ...
        return [
            ...
            "Comment Napoléon a-t-il établi son empire en Europe?",
            ...
            "Quel a été l'impact de Napoléon sur l'Angleterre et les Pays-Bas?",
            "L’impact de Napoléon sur l’Angleterre et les Pays-Bas a-t-il été destructeur?"
        ]
